/**
 * YouTube Fetch Script - English Long Videos
 *
 * Fetches long-form videos from English tech channels
 * Needs translation via n8n before publishing
 *
 * Usage: node scripts/fetch-youtube-en-videos.js
 */
...
// English YouTube channels - Long form reviews
const CHANNELS = [
  {
    name: 'Just Josh',
    slug: 'just-josh',
...
async function main() {
  console.log('🎬 YouTube Fetcher - English Long Videos')
